...
const SYNCACCOUNTS: SyncPairAccount[] = [
    new SyncPairAccount("1",YNABACCOUNTS[0], BANKACCOUNTS[0], "today 1", "My lovely budget 1"),
    new SyncPairAccount("2",YNABACCOUNTS[1], BANKACCOUNTS[1], "today 2", "My lovely budget 2"),
    new SyncPairAccount("3",YNABACCOUNTS[2], BANKACCOUNTS[2], "today 3", "My lovely budget 3")
];
export const TESTUSERS: User[] = [
    {id: 1, email: "my@email.com", name: "me my", password: "123", sync_pairs: [SYNCACCOUNTS[0]]},
    {id: 2, email: "his@email.com", name: "his johnson", password: "123", sync_pairs: [SYNCACCOUNTS[1]]},
    {id: 3, email: "her@email.com", name: "her fluffy", password: "123", sync_pairs: [SYNCACCOUNTS[2]]}
];
